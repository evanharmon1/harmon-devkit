...
- **Issue titles**: every map, spec, ticket, and follow-up uses
...
- **Map**: a single issue labelled `wayfinder:map`, holding the Notes / Decisions-so-far / Fog body. Its title follows the scoped-title convention above; create it with `gh issue create --label wayfinder:map`.
