...
> Explainer: The "issue tracker" is where issues live for this repo. Skills like `to-tickets`, `matt-triage`, and `to-spec` read from and write to it — they need to know whether to call `gh issue create`, write a markdown file under `.scratch/`, or follow some other workflow you describe. Pick the place you actually track work for this repo.
...
**Section B — Triage label vocabulary.** Skip this section entirely if the `matt-triage` skill isn't installed (exploration told you) — an uninstalled skill needs no labels.
