...
that is the report item. This covers *generic* credential health only; whether
a specific issue's new resource types need scopes the CI credential lacks is
