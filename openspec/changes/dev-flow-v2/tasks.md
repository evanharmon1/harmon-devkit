...
- Wave 1 (concurrent lanes, ordered merge): 2.1, 2.3, and 2.4 start
  ...
  each of 2.3 and 2.4 merges the updated `main` (never a rebase: pushed
  history is not rewritten) once 1.3 and 2.1 have merged, and re-runs its
