...
| [`universal/shepherd`](./ai/skills/universal/shepherd/)                       | Ready       | `/shepherd` — drive an open PR to green: watch CI and bot/human reviews, adjudicate findings as hypotheses, fix confirmed ones with per-thread replies, push, re-watch (max 4 rounds; never merges)                                                                        |
