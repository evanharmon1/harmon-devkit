...
| [`universal/orient`](./ai/skills/universal/orient/)                           | Ready       | `/orient` — start-of-session ritual: orient in the repo and compose a descriptive session name (emits a copy-pasteable `/rename`)                                                                                                                                         |
| [`universal/preflight`](./ai/skills/universal/preflight/)                     | Ready       | `/preflight` — pre-implementation sanity check: verify the target issue and related PRs against the live repo, then claim the issue                                                                                                                                       |
