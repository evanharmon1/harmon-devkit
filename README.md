...
| [`universal/shepherd`](./ai/skills/universal/shepherd/)                       | Ready       | `/shepherd` — shepherd a draft PR to ready for review: watch CI and bot/human reviews, adjudicate findings as hypotheses, fix confirmed ones with per-thread replies, push, re-watch (bounded by the resolved shepherd cap, or the repo's own; never merges)                                                                        |
