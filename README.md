...
| [`universal/shepherd`](./ai/skills/universal/shepherd/)                       | Ready       | `/shepherd` — shepherd a draft PR to ready for review: watch CI and bot/human reviews, adjudicate findings as hypotheses, fix confirmed ones with per-thread replies, push, re-watch (max 4 rounds, or the repo's own cap; never merges)                                                                        |
